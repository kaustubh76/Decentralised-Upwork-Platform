...
contract RatingTest is Test {
    ...
    function setUp() public {
        ...
        userManagement.grantRole(userManagement.MODERATOR_ROLE(), address(jobPosting));
    ...
    function testSubmitRating() public {
        ...
        Rating.RatingData memory ratingData = rating.getJobRating(jobId, client);
    ...
    function testUpdateUserReputation() public {
        ...
        UserManagement.User memory freelancerData = userManagement.getUser(freelancer);
    ...
    function _createJob() internal returns (uint256) {
        ...
        uint256 jobId = jobPosting.createJob("ipfs://job-description", JOB_BUDGET, block.timestamp + JOB_DURATION);        
        vm.stopPrank();

        vm.prank(freelancer);
        jobPosting.submitProposal(jobId);
