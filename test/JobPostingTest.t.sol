...
contract JobPostingTest is Test {
    ...
    */
    ...
    function testFailUnauthorizedActions() public {
        ...
        vm.expectRevert("AccessControl: account 0x0000000000000000000000000000000000000002 is missing role 0x3333f7ba63096e0feeff23993a70ebab9a83332c3d971c5a2f6f0e19d7a81792");
        vm.prank(freelancer);
        jobPosting.resolveDispute(0, freelancer);
    }
